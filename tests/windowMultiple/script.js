class DraggableWindow {
    ...
    centerWindow() {
        this.windowElement.style.left = `calc(50% - 250px)`;
        this.windowElement.style.top = `calc(50% - 150px)`;
    }
...
document.addEventListener('DOMContentLoaded', () => {
    const windows = [
        new DraggableWindow(
            createWindowElement('window1', 'This is the content of window 1'),
            document.querySelector('.windowIcon[data-window="1"]')
        ),
        new DraggableWindow(
            createWindowElement('window2', 'This is the content of window 2'),
            document.querySelector('.windowIcon[data-window="2"]')
        )
    ];
    
    function createWindowElement(id, content) {
        ...
        `;
        document.querySelector('.background').appendChild(windowElement);
