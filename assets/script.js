...
class PopupWindow {
  ...
  init() {
    ...
    this.windowElement
      ...
      .addEventListener("mousedown", (e) => this.startDrag(e));
  ...
  focusWindow() {
    document
      ...
      .forEach((window) => window.classList.remove("active"));
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function bgCanvasDrawGrid() {
    ...
    const gridSize = 30;
    const gridSizeX =
      bgCanvasGrid.width / Math.ceil(bgCanvasGrid.width / gridSize);
    const gridSizeY =
      bgCanvasGrid.height / Math.ceil(bgCanvasGrid.height / gridSize);
  ...
  function getCpuUsage() {
    cpuUsage = Math.max(
      4.1657,
      Math.min(98.2916, (cpuUsage + Math.random() * 15 - 7).toFixed(4))
    );
    return cpuUsage;
  }
  ...
  function getMemoryUsage() {
    memoryUsage = Math.max(
      8.1654,
      Math.min(83.9513, (memoryUsage + Math.random() * 6 - 3).toFixed(4))
    );
    return memoryUsage;
  }
  ...
  function createInputElement(chapter) {
    return new Promise((resolve) => {
      ...
      let inputChapter = document.querySelector(
        "#terminal-content div." + chapter
      );
      if (inputChapter) {
  ...
  function hideCursor(chapter) {
    if (chapter) {
      let cursor = document.querySelector(
        "#terminal-content p." + chapter + " .ti-cursor"
      );
      if (cursor) {
  ...
  function handleChapter1() {
    chapter1 = new TypeIt(createTextElement("chapter1"), {
      ...
      .type("GTCA OS")
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .type(
        'Bioinformatics GeneAccess BIOS <span class="color-yellow">v24.5.17</span>'
      )
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .type('<span class="color-green">Initializing system...</span>')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(1000)
      .break()
      ...
      .exec(() => scrollOneLineDown())
      .type(
        'Startup Time: <span class="color-yellow">' +
          getTimeDifference() +
          "</span>"
      )
      .break()
      ...
      .pause(200)
      .type(
        'Memory: <span class="color-yellow">256</span>GB DDR<span class="color-yellow">4</span>'
      )
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .type('Storage: <span class="color-yellow">5</span>TB NVMe SSD')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .type(
        'Viewport Size: <span class="color-yellow">' +
          window.innerWidth +
          '</span> x <span class="color-yellow">' +
          window.innerHeight +
          "</span>"
      )
      .break()
      ...
      .pause(200)
      .type(
        'Pixel Ratio: <span class="color-yellow">' +
      ...
      .pause(200)
      .type(
        'Color Depth: <span class="color-yellow">' +
      ...
      .exec(() => scrollOneLineDown())
      .pause(200)
      .type("Cookies Available: " + navigator.cookieEnabled)
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .type("Local Storage Available: " + (typeof Storage !== "undefined"))
      .break()
      .exec(() => scrollOneLineDown())
      .pause(500)
      .go();
  ...
  function handleChapter2() {
    fetchPublicIp().then(() => {
      ...
      chapter2 = new TypeIt(createTextElement("chapter2"), {
        ...
        .break()
        .exec(() => scrollOneLineDown())
        .type('Network: <span class="color-green">connected</span>')
        .break()
        .exec(() => scrollOneLineDown())
        .pause(200)
        .type(
          'Connection Type: <span class="color-yellow">' +
        ...
        .pause(200)
        .type(
          'Downlink Speed: <span class="color-yellow">' +
        ...
        .exec(() => scrollOneLineDown())
        .pause(200)
        .type('IP: <span class="color-yellow">' + publicIp + "</span>")
        .break()
        .exec(() => scrollOneLineDown())
        .pause(500)
        .go();
  ...
  function handleChapter3_1() {
    ...
    chapter3 = new TypeIt(createTextElement("chapter3"), {
      ...
      .break()
      .exec(() => scrollOneLineDown())
      .type('<span class="color-green">Analysing</span> location...')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .go();
  ...
  function handleChapter4_1() {
    ...
    chapter4 = new TypeIt(createTextElement("chapter4"), {
      ...
      .type('<span class="color-green">Analysing</span> local files...')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .go();
  ...
  function handleChapter5_1() {
    ...
    chapter5 = new TypeIt(createTextElement("chapter5"), {
      ...
      .type(
        '<span class="color-green">Analysing</span> web browsing history...'
      )
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
  ...
  function handleChapter6_1() {
    ...
    chapter6 = new TypeIt(createTextElement("chapter6"), {
      ...
      .type('<span class="color-green">Analysing</span> messages...')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .go();
  ...
  function handleChapter7() {
    ...
    chapter7 = new TypeIt(createTextElement("chapter7"), {
      ...
      .break()
      .exec(() => scrollOneLineDown())
      .type('<span class="color-blue">PLEASE ENTER YOUR INFORMATION:</span>')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .break()
  ...
  function handleChapter10_1() {
    chapter10 = new TypeIt(createTextElement("chapter10"), {
      ...
      .break()
      .exec(() => scrollOneLineDown())
      .type('<span class="color-green">Searching</span> data on user...')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(2000)
  ...
  function handleChapter11() {
    ...
    chapter11 = new TypeIt(createTextElement("chapter11"), {
      ...
      .type('<span class="color-green">Analysing</span> user data...')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .type('<span class="color-green">Generating</span> report...')
      .break()
      .exec(() => scrollOneLineDown())
      .pause(200)
      .go();
  ...
  document.querySelectorAll(".window").forEach((window, index) => {
    ...
    const iconElement = document.querySelector(
      `.windowIcon[data-window="${window.id}"]`
    );
    ...
    const resizeObserver = new ResizeObserver((entries) => {
      entries.forEach((entry) => {
        window.querySelector(
          ".footer p.windowSize"
        ).textContent = `${Math.floor(entry.contentRect.width)} x ${Math.floor(
  ...
  function initSystemInfo() {
    // user
    cdSystemInfo.querySelector("#systemInfoUser").textContent =
      "User: " + "Vincent Anton Freeman";
    // startup time
    cdSystemInfo.querySelector("#systemInfoStartup").textContent =
      "Startup: " + startTime.toLocaleTimeString("en-US", { hour12: false });
    // storage
    let storagePercentage = (
      Math.random() * (36.6481 - 27.9426) +
      27.9426
    ).toFixed(1);
    let storageTb = ((5 / 100) * storagePercentage).toFixed(1);
    cdStorage.textContent =
      "Storage: " + storagePercentage + " % | " + storageTb + " TB";
  }
  initSystemInfo();
